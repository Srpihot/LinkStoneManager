...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"干事名单查看", pos = wx.DefaultPosition, size = wx.Size( 583,373 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		icon = wx.EmptyIcon()
		...
		self.m_staticText9 = wx.StaticText( self, wx.ID_ANY, u"年龄：", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText18 = wx.StaticText( self, wx.ID_ANY, u"请输入查询的姓名：", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.save_button = wx.Button( self, wx.ID_ANY, u"获取", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.save_button, 1, wx.ALL|wx.EXPAND, 5 )

		self.true_button = wx.Button( self, wx.ID_ANY, u"修改", wx.DefaultPosition, wx.DefaultSize, 0 )
		bSizer14.Add( self.true_button, 1, wx.ALL|wx.EXPAND, 5 )
		...
		self.true_button.Bind( wx.EVT_BUTTON, self.change_ture )
